...
> Полный пошаговый мануал по развёртыванию в проде (с индексацией, эвалом,
> эксплуатацией и устранением проблем) — **[docs/DEPLOYMENT.md](docs/DEPLOYMENT.md)**.

## Требования

- Docker + Docker Compose.
- Доступ к общему Elasticsearch `http://192.168.31.31:9200` (индекс `help1c_docs_v2` уже собран)
  и к сервису эмбеддингов `http://192.168.31.32:8081/v1`.
- Свободный порт `8002` на хосте (старую версию сервиса на нём остановить).
